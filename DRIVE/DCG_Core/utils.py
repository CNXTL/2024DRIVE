...
p = "/hpc2hdd/home/tianlangxue/XAI4AD/concept_gridlock/scenarios/scenarios_small_100.txt"
# _10altered
print("-----------using concept datapath at:---",p)
with open(p) as file:
    lines = [line.strip() for line in file]
scenarios = lines
scenarios_tokens = clip.tokenize(scenarios)
print(scenarios_tokens.shape)

'''p = "/hpc2hdd/home/tianlangxue/XAI4AD/concept_gridlock/scenarios/scenarios_only_nuscenes_270.txt"
with open(p) as file:
    lines = [line.strip() for line in file]
scenarios = lines'''
